...
public class App {
    ...
    public static void main(String[] args) {
        ...
        String filePath = args[0] + "/render.png";
        int width = 10;
        int height = 10;
       ...
       try {
            model01.readOBJ("/Users/mr gino/Downloads/deer-mod.obj"); // tutaj ustaw ścieżkę!
            model02.readOBJ("/Users/mr gino/Downloads/deer-mod.obj"); // tu też
        } catch (IOException e) {
            e.printStackTrace();
        }
